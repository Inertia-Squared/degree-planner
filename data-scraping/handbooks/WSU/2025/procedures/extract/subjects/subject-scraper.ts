...
import {initSearch, regexMacros, scrape, setConfig, throwAndLog, TimerObjectType} from "@/api/util";
...
const CONFIG = {
    subjectFile: `${linksDir}/subject-details.json`,
    outputFile: `${dataDir}/subjects-unrefined.json`,
