...
/**
 * Fields from the unused API Endpoint
 */
...
/**
 * Fields reverse-engineered from the handbook API. We get out data from a different source, but some of the
 * info here may be useful, as it is much simpler to query and could be used to live-query the site
 * without needing to make things too complicated.
 */
