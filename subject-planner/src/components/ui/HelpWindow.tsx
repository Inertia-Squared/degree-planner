            ...
            className={`absolute right-0 top-24 z-31 flex flex-row ${
                !showHelp
                    ? `max-h-8 items-center border border-r-0 rounded-l-md bg-white ${
                          firstShowHelp ? "w-12 !bg-green-300" : "w-8"
                      }`
                    : ""
            }`}
        >
            <BsQuestion
                className={`${
                    showHelp ? `max-h-8 items-center border border-r-0 rounded-l-md bg-white` : ""
                }`}
                size={32}
            />
            {showHelp && (
                ...
                >
                    Welcome to <strong>MyDegree.help!</strong> To get started, you can type part or
                    all of a program name into the search bar, the dropdown will fill automatically
                    with any matching courses.
                    <br />
                    <br /> Selecting a Major or Minor is optional (if you don't want one, just don't
