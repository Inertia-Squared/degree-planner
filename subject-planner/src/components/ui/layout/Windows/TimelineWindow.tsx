    ...
    return (
        <>
            {shouldShowItem(selectedHeaderItem, itemIdentifier) && (
                <WindowContainer title={'Degree Timeline'} description={'This panel shows all your chosen subjects, grouped by semster.'} className={className} onClose={() => setSelectedHeaderItem(HeaderItem.NONE)} childElement={
